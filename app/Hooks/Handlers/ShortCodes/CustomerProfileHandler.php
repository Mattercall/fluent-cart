    ...
    public function renderCustomerMenu()
    {
        ...
        $menuItems = [
            ...
            'support-centre'   => [
                ...
                'css_class' => '',
                'link'  => apply_filters('fluent_cart/customer_portal/support_centre_url', home_url('/support')),
                'icon_svg' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M10 2.5C5.85786 2.5 2.5 5.85786 2.5 10C2.5 14.1421 5.85786 17.5 10 17.5H17.5V10C17.5 5.85786 14.1421 2.5 10 2.5ZM4 10C4 6.68629 6.68629 4 10 4C13.3137 4 16 6.68629 16 10V16H10C6.68629 16 4 13.3137 4 10ZM9.25 12.25H10.75V13.75H9.25V12.25ZM10 6.25C8.75736 6.25 7.75 7.25736 7.75 8.5H9.25C9.25 8.08579 9.58579 7.75 10 7.75C10.4142 7.75 10.75 8.08579 10.75 8.5C10.75 8.91421 10.4142 9.25 10 9.25H9.25V11.5H10.75V10.6425C11.6204 10.333 12.25 9.50256 12.25 8.5C12.25 7.25736 11.2426 6.25 10 6.25Z" fill="currentColor"/>
                </svg>'
            ]
        ];
